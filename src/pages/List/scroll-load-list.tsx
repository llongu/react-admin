...
export const handleInfiniteOnLoad = async (isUnInstall, listState, setListState): Promise<void> => {
  try {
  ...
  return (
    <>
      <div className={Styles["demo-infinite-container"]}>
        <InfiniteScroll
          pageStart={1}
          loadMore={(): Promise<void> => handleInfiniteOnLoad(isUnInstall, listState, setListState)}
